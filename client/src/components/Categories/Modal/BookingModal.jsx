...
const BookingModal = ({ closeModal, isOpen, bookingInfo }) => {
    ...
    // payment er kaj korini.. just kiso informtioation book kortesi db te
    const handleBooking = ()=> {
        console.log(bookingInfo)
         axiosCommon.post('/booking', bookingData )
         .then(res => {
            console.log(res?.data)
            if(res.data.acknowledged){

                axiosCommon.patch(`/room/status/${bookingInfo._id}`, {status: true})
                .then(res => {
                    console.log(res.data)
